...
// NIXTextEncoding
#define COCOAPODS_POD_AVAILABLE_NIXTextEncoding
#define COCOAPODS_VERSION_MAJOR_NIXTextEncoding 0
#define COCOAPODS_VERSION_MINOR_NIXTextEncoding 1
#define COCOAPODS_VERSION_PATCH_NIXTextEncoding 0
